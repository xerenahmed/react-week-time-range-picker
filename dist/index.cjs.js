...
const WeekTimeRangePickerThead = (props) => {
    ...
    return (React__default["default"].createElement("thead", null,
        React__default["default"].createElement("tr", null,
            React__default["default"].createElement("th", { rowSpan: 8, className: "week-td" }, theadFirstTd),
            theadTimeRange.map((item, i) => {
                return React__default["default"].createElement("th", { colSpan: 24, key: i }, item);
            })),
        React__default["default"].createElement("tr", null, hours.map((item, i) => {
            return React__default["default"].createElement("td", { colSpan: colspan, key: i }, item.hour);
        }))));
};
...
const WeekTimeRangeSelected = (props) => {
    ...
    return (React__default["default"].createElement("tr", { className: "wtrp-time-range-selected" },
        React__default["default"].createElement("td", { colSpan: 49, className: "wtrp-selected-td" },
            React__default["default"].createElement("div", { className: "wtrp-clearfix" },
                checkedDatas.length === 0 ?
                    React__default["default"].createElement("span", { className: "wtrp-fl tip-text" }, "Zaman aral\u0131\u011F\u0131n\u0131 se\u00E7mek i\u00E7in fareyi s\u00FCr\u00FCkleyin") :
                    React__default["default"].createElement("span", { className: "wtrp-fl tip-text" }, "Se\u00E7ilen zaman dilimi"),
                React__default["default"].createElement("a", { className: "wtrp-fr", onClick: handleClear }, "Se\u00E7imi Temizle")),
            cacheChecked.map((item, i) => {
                return (React__default["default"].createElement("div", { className: "wtrp-selected-td__selected-time", key: i },
                    React__default["default"].createElement("p", { className: "wtrp-flex wtrp-break" },
                        React__default["default"].createElement("span", { className: "tip-text" },
                            item.week,
                            "\uFF1A"),
                        React__default["default"].createElement("span", { className: "wtrp-flex-1" }, item.mergeTimes.map((time, timeIndex) => {
                            return React__default["default"].createElement("span", { className: "wtrp-selected-text", key: timeIndex }, hasHalfHour ? `${time[0]}~${time[time.length - 1]}` : `${time[0]}~` + fromat(time[time.length - 1]));
                        })))));
            }))));
};
...
const WeekTimeRangePickerTbody = (props) => {
    const [checkedDatas, setCheckedDatas] = React.useState(props.checkedDatas);
    React.useEffect(() => {
    ...
    return (React__default["default"].createElement("tbody", { className: "wtrp-tbody", onMouseDown: handleMousedown, onMouseUp: handleMouseup, onMouseMove: handleMousemove },
        weeks.map((item, i) => {
            return (React__default["default"].createElement("tr", { className: "wtrp-tbody-tr", key: i },
                React__default["default"].createElement("td", { className: "week-td" }, item.week),
                hours.map((hour, index) => {
                    return (React__default["default"].createElement("td", { colSpan: colspan, className: checkedDatas.some(checked => {
        ...
        React__default["default"].createElement(WeekTimeRangeSelected, { hasHalfHour: hasHalfHour, checkedDatas: checkedDatas, handleEmpty: handleEmpty })));
};
...
const ReactWeekTimeRangePicker = (props) => {
    ...
    const [cacheChecked, setCacheChecked] = React.useState(props.selectedData || []); // 缓存被选中的时间数据
    React.useEffect(() => {
    ...
    return (React__default["default"].createElement("div", { className: "week-time-range-picker" },
        ...
        React__default["default"].createElement("table", { className: "wtrp-table" },
            React__default["default"].createElement(WeekTimeRangePickerThead, { hasHalfHour: hasHalfHour }),
            React__default["default"].createElement(WeekTimeRangePickerTbody, { hasHalfHour: hasHalfHour, checkedDatas: cacheChecked, handleDrag: handleDrag, handleSelect: handleSelect, handleMoveout: handleMoveout }))));
};

module.exports = ReactWeekTimeRangePicker;
